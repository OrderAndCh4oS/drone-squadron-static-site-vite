...
export const playerOneInput = document.getElementById('player-one-input');
export const playerTwoInput = document.getElementById('player-two-input');
export const randomOne = document.getElementById('random-one');
export const randomTwo = document.getElementById('random-two');
randomOne.addEventListener('click', () => {
    playerOneInput.value = objktIds[~~(objktIds.length * Math.random())].id
});
randomTwo.addEventListener('click', () => {
    playerTwoInput.value = objktIds[~~(objktIds.length * Math.random())].id
});
